...
if len(argv) != 11:
  ...
  elif lipid_type == "PIPC": bond_names = phosphatidylcholine_bond_names + "GL1-C1B GL2-C1A C1A-C2A C2A-C3A C3A-C4A C1B-D2B D2B-C3B C3B-C4B\n"
  elif lipid_type == "PGPC": bond_names = phosphatidylcholine_bond_names + "GL1-C1A GL2-C1B C1A-C2A C2A-D3A D3A-C4A C4A-C5A C1B-C2B C2B-C3B C3B-C4B\n"
  # PEs
  ...
  # PS
  elif lipid_type == "PAPS": bond_names = "CNO-PO4 PO4-GL1 GL1-GL2 GL1-D1A D1A-D2A D2A-D3A D3A-D4A D4A-C5A GL2-C1B C1B-C2B C2B-C3B C3B-C4B\n"
  elif lipid_type == "PRPS": bond_names = "CNO-PO4 PO4-GL1 GL1-GL2 GL1-D1A D1A-D2A D2A-D3A D3A-D4A D4A-D5A D5A-D6A GL2-C1B C1B-C2B C2B-C3B C3B-C4B\n"
  #PI
  elif lipid_type == "PAPI": bond_names = "C1-C2 C1-C3 C2-C3 C1-PO4 PO4-GL1 GL1-GL2 GL1-D1A D1A-D2A D2A-D3A D3A-D4A D4A-C5A GL2-C1B C1B-C2B C2B-C3B C3B-C4B\n"
  #Lyso
  elif lipid_type == "PPC": bond_names = "NC3-PO4 PO4-GL1 GL1-GL2 GL2-C1B C1B-C2B C2B-C3B C3B-C4B\n"
  elif lipid_type == "PPS": bond_names = "CNO-PO4 PO4-GL1 GL1-GL2 GL2-C1B C1B-C2B C2B-C3B C3B-C4B\n"
  #SM
  ...
  command = "echo %s | gmx_mpi trjconv -f %s -s %s -b %i -e %i -sep -skip %i -pbc whole -o frame_dump_.gro > /dev/null" % (lipid_type, trajfile, tprfile, initial_time, final_time, traj_skip)
  print command
